...
const WhatsAppButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-10 left-6 z-[55] w-20 h-20 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group hover:scale-110"
